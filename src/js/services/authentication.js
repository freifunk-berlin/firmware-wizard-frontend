...
module.exports = function(app) {
  app.factory('authentication', ['$q', 'jsonrpc', function($q, jsonrpc) {
    const INITIAL_SESSION_ID = '00000000000000000000000000000000';
    ...
    factory.isAuthenticated = function() {
      if (sessionId === INITIAL_SESSION_ID || apiUrl === '' || Math.floor(Date.now() / 1000) - sessionStartTimestamp > SESSION_TIMEOUT_IN_SECONDS) {
        return false;
      }
      return true;
    };
    ...
    factory.authenticate = function(apiUrl, username, password) {
      ...
      this.apiUrl = apiUrl;
      var args = {'username': username, 'password': password, 'timeout': SESSION_TIMEOUT_IN_SECONDS};
